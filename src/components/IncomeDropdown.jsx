...
const IncomeDropdownMenu = React.forwardRef(({ selectedIncomes, setSelectedIncomes }, ref) => {
  ...
  return (
    <div  style={{ top: `${incomeTop + 42}px`, left:  `${incomeLeft}px`}} className="absolute bg-[rgb(251,251,251)] rounded-lg w-auto max-w-[600px] flex flex-col whitespace-wrap" ref={ref}>
